...
export function HomeScreen({ initialCategory = "lines", onNavigate }: HomeScreenProps) {
  ...
  return (
    <div className="flex h-full w-full flex-col overflow-hidden">
      ...
      >
        <div className="flex min-h-0 flex-1 items-stretch overflow-x-auto overflow-y-hidden px-[2.8%] py-[1.5%] [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          <AnimatePresence mode="wait">
            <motion.div
              key={activeId}
              className="flex h-full min-w-min items-stretch gap-[2.8%] pr-[2.8%]"
