...
export function HomeScreen({ initialCategory = "lines", onNavigate }: HomeScreenProps) {
  ...
  return (
    <div className="flex h-full w-full flex-col overflow-hidden">
      ...
      >
        <div className="flex min-h-0 flex-1 items-stretch gap-2.5 overflow-x-auto overflow-y-hidden px-2 py-1.5 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
