...
export function TabIcon({ id, className = "h-7 w-7" }: TabIconProps) {
  switch (id) {
    case "colors":
      return (
    ...
    case "connect":
      return (
        <svg viewBox="0 0 48 48" className={className} aria-hidden>
          ...
          <line x1="14" y1="34" x2="24" y2="24" stroke="#CC44AA" strokeWidth="4.5" strokeLinecap="round" />
          <line x1="24" y1="24" x2="34" y2="14" stroke="#CC44AA" strokeWidth="4.5" strokeLinecap="round" />
        </svg>
      );
    case "mazes":
      return (
